...
public:
    Reader(){
        ...
        current_file_name="/Users/tessdaughton/Desktop/cs412/project_1/bunny.obj";
        read_file();
    }
    ...
    void set_current_color(GLfloat *color)
    {
        memcpy(&color, current_color, sizeof(color));
        for(int i=3; i<vertices.size()-3; i+=3)
            {
                vertices.at(i)=current_color[0];
                vertices.at(i+1)=current_color[1];
                vertices.at(i+2)=current_color[2];
            }
    }
};
